    ...
    <>
      ...
      <div id="loginScreen">
        <div className="login-card">
          ...
          <p>Please log in to manage your patient records.</p>
          ...
          <button id="loginSubmitBtn" className="login-btn">Login</button>
        </div>
      </div>

      {/* ================= MAIN APP ================= */}
      <div className="app" id="mainAppContent" style={{ display: 'none' }}>
        <div className="card">
          <header className="header">
            <div style={{ display: 'flex', alignItems: 'center' }}>
                <h1>Patient Record</h1>
                <span id="welcomeDoctorName" style={{ marginLeft: "15px", fontWeight: "normal", fontSize: "0.9rem" }}></span>
            </div>
            <div>
                <span className="date" id="headerDate"></span>
                {/* NEW LOGOUT BUTTON */}
                <button id="logoutBtn" className="danger" style={{ marginLeft: "15px", padding: "5px 15px", height: "auto" }}>Logout</button>
            </div>
          </header>
        ...
        <div id="testsModal" className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <textarea id="testsBox" className="large-box" style={{height: "200px"}} placeholder="Enter details..."></textarea>
